...
hold_lon=vehicle.location.global_relative_frame.lon
hold_lat=vehicle.location.global_relative_frame.lat

for x in range (0,5):
    y_coord=round(random.uniform(5,5.5),2)
    print("goto: %f" % y_coord )
    goto(hold_lat,hold_lon,y_coord)
