...
class engage_target:
    ...
    const_cm_pix = 0.44963 # this mutiplied by distance gives cm/pix
    x_centre = 160
    y_centre = 100
    ...
    def target_dist(self):
        if self.target_info[2] != 0:
            ...
            target_distance = guess_width/(elf.target_info[3]*const_cm_pix)
    ...
    def calc_x_velocity(self):
        if self.target_info[0] == 0:
            ...
            x_vel = (round((self.target_info[0]-x_centre)/2,3)*100)/const_cm_pix*target_distance # m/s to one decimal
        return x_vel
    ...
    def calc_y_velocity(self):
        if self.target_info[1] == 0:
            ...
            y_vel = (round((self.target_info[1]-y_centre)/2,3)*100)/const_cm_pix*target_distance #m/s to one decimal
        return y_vel
